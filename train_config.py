...
config.MODEL.model_path = './model'                                    # save directory
config.MODEL.checkpoints_path = "./model"
...
config.DATA = edict()
config.DATA.root_path='/home/ubuntu/seg'
# config.DATA.train_txt_path='train.txt'
# config.DATA.val_txt_path='val.txt'
config.DATA.train_txt_path='/home/ubuntu/seg/TAD16K/signbox_labels_train.txt'
config.DATA.val_txt_path='/home/ubuntu/seg/TAD16K/signbox_labels_valid.txt'
